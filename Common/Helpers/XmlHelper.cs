...
namespace Globe.QcApp.Common.Helpers
{
    class XmlHelper
    {
       ...
       #region 字段
        ...
        public static XmlNodeList GetXmlNodeList(string xPath)
        ...
        public static XmlAttribute GetXmlAttribute(string xPath,string attributeName)
        {
            if (_FilePath == string.Empty)
            {
                return null;
        ...
        public static XmlAttributeCollection GetNodeAttributes(string xPath)
        {
            if (_FilePath == string.Empty)
            {
                return null;
